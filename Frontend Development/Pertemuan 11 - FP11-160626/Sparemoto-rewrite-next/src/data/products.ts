...
export const products: Product[] = [
  ...
  { id: 'brk-005', name: 'Master Cylinder Assembly', category: 'Brake Systems', categorySlug: 'brakes', price: 119.00, description: 'Radial master cylinder for precise brake modulation and powerful stopping force.', specs: ['Radial mount design', 'Forged body', 'Adjustable lever ratio', '19mm bore'], inStock: true, rating: 4.9, reviews: 43 },
  { id: 'brk-006', name: 'Rear Brake Pads', category: 'Brake Systems', categorySlug: 'brakes', price: 29.99, description: 'OEM-replacement rear brake pads with organic compound for smooth, progressive braking feel.', specs: ['Organic compound', 'Quiet operation', 'OEM fitment', 'Low rotor wear'], inStock: true, rating: 4.3, reviews: 87 },
  ...
  { id: 'elc-005', name: 'Wiring Harness (Main)', category: 'Electrical', categorySlug: 'electrical', price: 224.99, description: 'Complete main wiring harness with color-coded wires and factory-style connectors. For full electrical restoration.', specs: ['Color-coded wires', 'OEM connectors', 'Complete harness', 'Installation diagram'], inStock: false, rating: 4.4, reviews: 22 },
  { id: 'elc-006', name: 'Ignition Coil Pack', category: 'Electrical', categorySlug: 'electrical', price: 59.99, description: 'High-energy ignition coil for stronger spark and improved combustion. Direct OEM replacement.', specs: ['Higher energy output', 'Silicone boots included', 'Direct replacement', 'Epoxy-filled'], inStock: true, rating: 4.5, reviews: 78 },
  ...
  { id: 'exh-002', name: 'Slip-On Muffler', category: 'Exhaust', categorySlug: 'exhaust', price: 299.99, description: 'Bolt-on slip-on muffler with aggressive sound and easy installation. No header modification required.', specs: ['Titanium shell', 'Bolt-on install', 'DB killer included', 'No mapping needed'], inStock: true, rating: 4.7, reviews: 145 },
  ...
  { id: 'drv-005', name: 'Clutch Cable', category: 'Drivetrain', categorySlug: 'drivetrain', price: 22.50, description: 'OEM-length clutch cable with Teflon-lined inner wire for smooth, low-effort operation.', specs: ['Teflon lined', 'OEM length', 'Stainless inner wire', 'Nylon outer jacket'], inStock: true, rating: 4.3, reviews: 54 },
];
